            ...
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">CUGI Mama</div><small>Administrator</small></div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="mail_view.php">Mail view</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a href="calendar.php"><i class="sidebar-item-icon fa fa-calendar"></i>
                    ...
                    <li>
                        ...
                        <ul class="nav-2-level collapse">
                            ...
                            <li>
                                <a href="error_404.php">404 error</a>
                            </li>
                            <li>
                                <a href="error_500.php">500 error</a>
                            </li>
                        </ul>
                    </li>
                    <li>
